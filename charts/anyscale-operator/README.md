...
| `operator.container.image.tag` | string | `ci-a11604f8f31c73de3b97a6d06c29809fc9468f9d` | Operator container image tag. Updated with helm releases. Anyscale support may provide preview versions. |
