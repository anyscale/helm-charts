...
| `operator.container.image.tag` | string | `ci-88f9457a271596eba81a8681ce0bb9ff3e92a346` | Operator container image tag. Updated with helm releases. Anyscale support may provide preview versions. |
