...
| `operator.container.image.tag` | string | See values.yaml | Operator container image tag. Updated with helm releases. Anyscale support may provide preview versions. |
