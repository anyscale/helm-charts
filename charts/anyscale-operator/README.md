...
| `operator.container.image.tag` | string | `ci-9a261b60f646d61c985d07ea4ed48579f0f85254` | Operator container image tag. Updated with helm releases. Anyscale support may provide preview versions. |
