...
| `operator.container.image.tag` | string | `ci-a7c4ba68aa442b017a873acc21795ff5fb66e8ef` | Operator container image tag. Updated with helm releases. Anyscale support may provide preview versions. |
